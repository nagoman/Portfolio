    ...
    <div className="site-shell">
      <header className="hero" id="top">
        ...
        <section className="cover page-section">
          ...
          <aside className="executive-card" aria-label="Contact snapshot">
      ...
      <main>
        ...
        <section className="page-section" id="skills">
          <SectionHeader eyebrow="Core Competencies" title="Executive-ready digital banking and product delivery skills." />
